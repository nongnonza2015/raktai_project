...
if img_file is not None:
    ...
    if st.session_state.ai_data:
        ...
        if risk_score >= 4:  # แสดงเฉพาะเมื่อมีความเสี่ยงปานกลางขึ้นไป
            ...
            hospitals = {
                "อำเภอเมืองสกลนคร": {"name": "โรงพยาบาลสกลนคร", "tel": "042-711-037", "map": "https://maps.app.goo.gl/XXXX"},
                "อำเภอกุสุมาลย์": {"name": "โรงพยาบาลกุสุมาลย์", "tel": "042-769-023", "map": "https://maps.app.goo.gl/XXXX"},
                "อำเภอพรรณานิคม": {"name": "โรงพยาบาลพรรณานิคม", "tel": "042-741-111", "map": "https://maps.app.goo.gl/XXXX"},
                "อำเภอพังโคน": {"name": "โรงพยาบาลพังโคน", "tel": "042-771-222", "map": "https://maps.app.goo.gl/XXXX"},
                "อื่นๆ": {"name": "สถานพยาบาลใกล้บ้านท่าน", "tel": "1669", "map": "https://www.google.com/maps"}
            }
