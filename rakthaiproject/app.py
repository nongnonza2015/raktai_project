...
import pandas as pd  # สำหรับจัดการฐานข้อมูล
import os            # สำหรับจัดการไฟล์
from datetime import datetime # สำหรับเก็บเวลาที่ตรวจ
...
with col3:
    ...
    # แยกเป็น Checkbox เดี่ยวๆ ให้ตรงกับ Google Form
...
if camera_photo is not None:
    ...
    if st.button("📥 บันทึกผลการคัดกรองเคสนี้"):
        with st.spinner("กำลังส่งข้อมูล..."):
            try:
                # 1. บันทึกลง Local CSV (เพื่อให้กราฟ Dashboard ด้านล่างมีข้อมูลแสดงผล)
